          ...
          <ul>
            <li>
              <a href="tel: +84896666825">
                <svg width="18" height="18" viewBox="0 0 20 20" fill="none" xmlns="../www.w3.org/2000/svg.html">
          ...
          <ul>
            <li><a href="#"><svg width="15" height="15" viewBox="0 0 15 15" fill="none"
                  ...
                  <g clip-path="url(#clip0_195_14)">
                    <mask id="mask0_195_14" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="0" y="0"
                      width="15" height="15">
                    ...
                    <g mask="url(#mask0_195_14)">
                      <path
                        ...
                        fill="white" />
                      <path d="M0.248047 4.98535H3.35805V14.9997H0.248047V4.98535Z" fill="white" />
                      <path
            ...
            <li><a href="#"><svg width="15" height="15" viewBox="0 0 15 15" fill="none"
                  ...
                  <g clip-path="url(#clip0_195_35)">
                    <mask id="mask0_195_35" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="0" y="0"
                      width="15" height="15">
                      <path d="M15 0H0V15H15V0Z" fill="white" />
                    </mask>
            ...
            <li><a href="#"><svg width="15" height="15" viewBox="0 0 15 15" fill="none"
                  ...
                  <g clip-path="url(#clip0_195_22)">
                    <mask id="mask0_195_22" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="0" y="0"
                      width="15" height="15">
                      <path d="M15 0H0V15H15V0Z" fill="white" />
                    </mask>
            ...
            <div class="pt-middle-menu">
              <div id="mega-menu-wrap-primary" class="mega-menu-wrap">
                ...
                <ul id="mega-menu-primary" class="mega-menu max-mega-menu mega-menu-horizontal mega-no-js"
                  ...
                  data-effect-mobile="slide_right" data-effect-speed-mobile="200" data-mobile-force-width="body"
                  data-second-click="go" data-document-click="collapse" data-vertical-behaviour="standard"
                  data-breakpoint="1200" data-unbind="true" data-mobile-state="collapse_all"
                  ...
                  <li
                    ...
                    <ul class="mega-sub-menu">
                      ...
                      <li
                        ...
                        id="mega-menu-item-2524"><a class="mega-menu-link" href="fish-market/index.html">Fish Market</a>
                      </li>
                      <li
                        class="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-2525"
                        id="mega-menu-item-2525"><a class="mega-menu-link" href="restaurant-grid/index.html">Restaurant
                          Grid</a></li>
                    </ul>
                  </li>
                  <li
                    class="mega-menu-item mega-menu-item-type-custom mega-menu-item-object-custom mega-menu-item-has-children mega-align-bottom-left mega-menu-flyout mega-dropdown mega-menu-item-2537"
                    id="mega-menu-item-2537"><a class="mega-menu-link" href="#" aria-expanded="false"
                      tabindex="0">Pages<span class="mega-indicator" aria-hidden="true"></span></a>
                    <ul class="mega-sub-menu">
                      <li
                        class="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-2534"
                        id="mega-menu-item-2534"><a class="mega-menu-link" href="about-us/index.html">Thông tin về chúng
                          tôi</a></li>
                      <li
                        class="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-2535"
                        id="mega-menu-item-2535"><a class="mega-menu-link" href="chef-team/index.html">Đội ngũ bếp</a>
                      </li>
                      <li
                        class="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-2530"
                        id="mega-menu-item-2530"><a class="mega-menu-link" href="our-services/index.html">Các dịch vụ
                          của chúng tôi</a></li>
                      <li
                        class="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-2531"
                        id="mega-menu-item-2531"><a class="mega-menu-link" href="our-locations/index.html">Địa điểm</a>
                      </li>
                      <li
                        class="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-2532"
                        id="mega-menu-item-2532"><a class="mega-menu-link" href="booking-page/index.html">Đặt bàn</a>
                      </li>
                      <li
                        class="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-2529"
                        id="mega-menu-item-2529"><a class="mega-menu-link" href="our-gallery/index.html">Our Gallery</a>
                      </li>
                      <li
                        class="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-2528"
                        id="mega-menu-item-2528"><a class="mega-menu-link" href="our-prices/index.html">Our Prices</a>
                      </li>
                      <li
                        class="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-4218"
                        id="mega-menu-item-4218"><a class="mega-menu-link" href="faqs/index.html">FAQs</a></li>
                      <li
                        class="mega-menu-item mega-menu-item-type-custom mega-menu-item-object-custom mega-menu-item-4217"
                        id="mega-menu-item-4217"><a class="mega-menu-link" href="3443.html">404 Page</a></li>
                    </ul>
                  </li>
                  <li
                    class="mega-menu-item mega-menu-item-type-custom mega-menu-item-object-custom mega-menu-item-has-children mega-align-bottom-left mega-menu-flyout mega-dropdown mega-menu-item-2540"
                    id="mega-menu-item-2540"><a class="mega-menu-link" href="#" aria-expanded="false"
                      tabindex="0">Menu<span class="mega-indicator" aria-hidden="true"></span></a>
                    <ul class="mega-sub-menu">
                      <li
                        class="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-2533"
                        id="mega-menu-item-2533"><a class="mega-menu-link" href="our-menu/index.html">Our Menu</a></li>
                      <li
                        class="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-3129"
                        id="mega-menu-item-3129"><a class="mega-menu-link" href="our-menu-two/index.html">Our Menu
                          Two</a></li>
                    </ul>
                  </li>
                  <li
                    class="mega-menu-item mega-menu-item-type-custom mega-menu-item-object-custom mega-menu-item-has-children mega-align-bottom-left mega-menu-flyout mega-dropdown mega-menu-item-2539"
                    id="mega-menu-item-2539"><a class="mega-menu-link" href="#" aria-expanded="false"
                      tabindex="0">Shop<span class="mega-indicator" aria-hidden="true"></span></a>
                    <ul class="mega-sub-menu">
                      <li
                        class="mega-menu-item mega-menu-item-type-custom mega-menu-item-object-custom mega-menu-item-2731"
                        id="mega-menu-item-2731"><a class="mega-menu-link" href="shop/index.html">Product List</a></li>
                      <li
                        class="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-2729"
                        id="mega-menu-item-2729"><a class="mega-menu-link" href="3-column-shop/index.html">Product
                          Grid</a></li>
                      <li
                        class="mega-menu-item mega-menu-item-type-custom mega-menu-item-object-custom mega-menu-item-3065"
                        id="mega-menu-item-3065"><a class="mega-menu-link"
                          href="product/grilled-salmon/index.html">Product Single</a></li>
                      <li
                        class="mega-menu-item mega-menu-item-type-custom mega-menu-item-object-custom mega-menu-item-2732"
                        id="mega-menu-item-2732"><a class="mega-menu-link" href="cart/index.html">cart</a></li>
                      <li
                        class="mega-menu-item mega-menu-item-type-custom mega-menu-item-object-custom mega-menu-item-2733"
                        id="mega-menu-item-2733"><a class="mega-menu-link" href="checkout/index.html">Checkout</a></li>
                    </ul>
                  </li>
                  <li
                    class="mega-menu-item mega-menu-item-type-custom mega-menu-item-object-custom mega-menu-item-has-children mega-align-bottom-left mega-menu-flyout mega-dropdown mega-menu-item-2746"
                    id="mega-menu-item-2746"><a class="mega-menu-link" href="#" aria-expanded="false"
                      tabindex="0">Blog<span class="mega-indicator" aria-hidden="true"></span></a>
                    <ul class="mega-sub-menu">
                      <li
                        class="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-2536"
                        id="mega-menu-item-2536"><a class="mega-menu-link" href="blog-grid/index.html">Blog Grid</a>
                      </li>
                      <li
                        class="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-2747"
                        id="mega-menu-item-2747"><a class="mega-menu-link" href="blog-list/index.html">Blog List</a>
                      </li>
                      <li
                        class="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-2748"
                        id="mega-menu-item-2748"><a class="mega-menu-link" href="blog-standard/index.html">Blog
                          Sidebar</a></li>
                      <li
                        class="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-post mega-menu-item-4299"
                  ...
                  <li
                    class="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-align-bottom-left mega-menu-flyout mega-menu-item-2527"
                    id="mega-menu-item-2527"><a class="mega-menu-link" href="contact-us/index.html" tabindex="0">contact
                      us</a></li>
                </ul>
              </div>
            </div>
                ...
                <ul>
                  <li class="pt-cart-button">
                    <a href="javascript:void(0)" class="pt-tools-button" data-bs-toggle="offcanvas"
                      data-bs-target="#offcanvascart"><svg width="23" height="28" viewBox="0 0 23 28" fill="none"
                        xmlns="../www.w3.org/2000/svg.html">
                        <path
                    ...
                    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvascart"><button type="button"
                        class="btn-close" data-bs-dismiss="offcanvas"><i class="ti-close"></i></button>
                      <div class="pt-cart-header">
                        <h3 class="modal-title">Cart <span class="cart-panel-counter">0</span> </h3>
                      </div>
                      <div class="widget_shopping_cart_content">

                        <p class="woocommerce-mini-cart__empty-message">Không có món ăn nào được chọn.</p>
                  ...
                  <li class="pt-search-button">
                    ...
                    <a href="javascript:void(0)" class="pt-tools-serach-button" data-bs-toggle="offcanvas"
                      data-bs-target="#offcanvassearch"><svg width="29" height="28" viewBox="0 0 29 28" fill="none"
                        xmlns="../www.w3.org/2000/svg.html">
                        <path
                    ...
                    <div class="offcanvas offcanvas-top" tabindex="-1" id="offcanvassearch">
                      ...
                      <form role="search" method="get" class="search-form" action="https://seabite.peacefulqode.in/">
